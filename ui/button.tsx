...
const ButtonShopNow = ({ paddingAndStyle, value }: any): any => {
  return (
    <button
      className={`z-[1] mt-4 flex w-max items-center gap-4 rounded-md bg-[#1E2328] font-body text-xs text-white outline-none transition-all hover:gap-5 hover:bg-yellow-500 ${paddingAndStyle}`}
    >
      {value}
...
const ButtonAddToCart = ({ className, onClick }: any): any => {
  return (
    <button
      name="button"
      onClick={onClick}
      className={`group/btn z-[1] mx-[10px] mt-4 flex h-12 w-full items-center justify-center gap-4 rounded-md  bg-[#1E2328] px-3 font-body text-xs text-white outline-none transition-all duration-300 hover:-translate-y-1 hover:bg-yellow-500 ${className}`}
    >
...
const ButtonAdd = (): any => (
  <button
    name="button"
    className="group/btn inline-flex h-8 items-center gap-2 rounded-md bg-[#a0d9f9] px-3 font-body text-[#0062b0] transition-transform duration-500 hover:-translate-y-1 hover:bg-[#1E2328] hover:fill-white hover:text-white"
  >
    ...
    >
      ...
      >
        <li
          ...
          className={` flex h-[30px] items-center px-4 font-body text-base hover:bg-[#93A484] ${
            filteringCount === 15
