      ...
      <div className="mt-[50px] flex md:flex-row flex-col items-center md:justify-between justify-center md:gap-5 gap-4 border-t border-emerald-300 px-4 py-6 ">
        ...
        <div className="flex lg:flex-row xl:gap-10 lg:gap-5 gap-3 flex-col">
          ...
          <CallIcon className=' fill-gray-400 lg:w-10 w-9 lg:h-10 h-9' />
            <div>
              <h1 className="font-head md:text-[26px]  text-emerald-500 text-h5  lg:leading-10 leading-3">
                1900 - 6666 - 
              </h1>
        ...
        <div>
          <div className="inline-flex w-full items-end justify-between lg:gap-4 gap-2 lg:flex-row md:flex-col flex-row">
            <h3 className="font-head md:text-base text-sm text-gray-700">Follows us</h3>
