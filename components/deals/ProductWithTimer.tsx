  ...
  return (
    <div className="group/body relative flex min-w-[310px] flex-1 flex-col overflow-hidden rounded-[18px] pb-10 md:min-w-full lg:max-w-[310px]">
      ...
      <div className="absolute bottom-4 flex w-full flex-col items-center justify-center transition-transform duration-300 group-hover/body:-translate-y-1">
        <div className="md:mb-3 mb-2 flex w-full flex-row items-center justify-center gap-1 rounded">
          <div className="flex w-12 flex-col items-center justify-center rounded-md bg-white p-3">
            <p className="font-head md:text-xl text-lg md:leading-6 leading-5 text-emerald-500">55</p>
            <p className="text-body md:text-base text-sm text-gray-700">Days</p>
          </div>
          <div className="flex w-12 flex-col items-center justify-center rounded-md bg-white p-3">
            <p className="font-head md:text-xl text-lg md:leading-6 leading-5 text-emerald-500">55</p>
            <p className="text-body md:text-base text-sm text-gray-700">Hours</p>
          </div>
          <div className="flex w-12 flex-col items-center justify-center rounded-md bg-white p-3">
            <p className="font-head md:text-xl text-lg md:leading-6 leading-5 text-emerald-500">55</p>
            <p className="text-body md:text-base text-sm text-gray-700">Mins</p>
          </div>
          <div className="flex w-12 flex-col items-center justify-center rounded-md bg-white p-3">
            <p className="font-head md:text-xl text-lg md:leading-6 leading-5 text-emerald-500">55</p>
            <p className="text-body md:text-base text-sm text-gray-700">Secs</p>
          </div>
        </div>
