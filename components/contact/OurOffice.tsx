          ...
          {item.office?.map((office) => (
            ...
            >
              ...
              <motion.button
                ...
                className="mt-5 inline-flex w-max items-center justify-center gap-1 rounded-md border-none bg-[#1E2328] py-2 px-[18px] font-head text-xs text-white outline-none duration-300 hover:-translate-y-1 hover:bg-yellow-500"
              >
