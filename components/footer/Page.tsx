...
const Footer = () => {
  ...
  return (
    <footer className="mt-[80px] flex w-full flex-col items-center justify-center overflow-hidden">
      <ul className="flex w-full flex-col items-center justify-between gap-4 bg-emerald-500 px-4 py-2 md:flex-row">
        ...
        {/* new */}
        <div className="flex gap-4 max-sm:flex-wrap max-sm:flex-col items-start">
