        ...
        {products.details.map((item: { id: React.Key; part: string }) => (
          <React.Fragment key={item.id}>
            <span
              ...
              className={`hidden items-center rounded-full border py-3 px-5 font-head text-base duration-300  hover:-translate-y-1  hover:text-[#5E665D] hover:shadow-md lg:flex ${
                isSelected === item.part ? 'text-[#5E665D]' : 'text-gray-700'
              }`}
            >
              {item.part}
            </span>
